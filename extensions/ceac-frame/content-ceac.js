...
if (window.__cpVistosCeacFillV15 && typeof window.__cpVistosRunFill === "function") {
  ...
  const FIELD_ALIASES = {
    ...
    groupName: ["groupname"],
    fatherGiven: ["fathersgiven", "fathergiven", "fatherfirstname"],
    fatherSurname: ["fatherssurname", "fathersurname", "fatherlastname"],
    fatherName: ["fatherfullname", "fathername"],
    motherGiven: ["mothersgiven", "mothergiven", "motherfirstname"],
    motherSurname: ["motherssurname", "mothersurname", "motherlastname"],
    motherName: ["motherfullname", "mothername"],
