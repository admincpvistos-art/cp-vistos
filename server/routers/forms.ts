    ...
    .mutation(async (opts) => {
      ...
      await prisma.form.update({
        ...
        data: {
          ...
          warName: warNameConfirmation === "Sim" ? warName : "",
          fullNameNative: fullNameNative?.trim() ? fullNameNative.trim() : null,
  ...
  savePersonalData: isUserAuthedProcedure
    .input(
      z.object({
        ...
        warNameConfirmation: z.enum(["Sim", "Não"]).nullable(),
    ...
    .query(async (opts) => {
      ...
      const contactAndAddressForm = await prisma.form.findFirst({
        ...
        select: {
          ...
          postalStreet: true,
          postalAddressNumber: true,
          postalComplement: true,
          postalDistrict: true,
          postalCity: true,
          postalState: true,
          postalCep: true,
        ...
        data: {
          ...
          otherPostalAddress:
            postalAddressConfirmation === "Sim"
              ...
              : "",
          postalStreet: postalAddressConfirmation === "Sim" ? postalStreet : "",
          postalAddressNumber: postalAddressConfirmation === "Sim" ? postalAddressNumber : "",
          postalComplement: postalAddressConfirmation === "Sim" ? postalComplement : "",
          postalDistrict: postalAddressConfirmation === "Sim" ? postalDistrict : "",
          postalCity: postalAddressConfirmation === "Sim" ? postalCity : "",
          postalState: postalAddressConfirmation === "Sim" ? postalState : "",
          postalCep: postalAddressConfirmation === "Sim" ? postalCep : "",
          postalCountry: postalAddressConfirmation === "Sim" ? postalCountry : "",
          cel,
          tel,
  ...
  saveContactAndAddress: isUserAuthedProcedure
    .input(
      z.object({
        ...
        postalStreet: z.string().nullable(),
        postalAddressNumber: z.string().nullable(),
        postalComplement: z.string().nullable(),
        postalDistrict: z.string().nullable(),
        postalCity: z.string().nullable(),
        postalState: z.string().nullable(),
        postalCep: z.string().nullable(),
        postalCountry: z.string().nullable(),
    ...
    .mutation(async (opts) => {
      ...
      await prisma.form.update({
        ...
        data: {
          passportNumber,
          passportDocumentType,
          bookNumber: bookNumber?.trim() ? bookNumber.trim() : null,
          passportCity,
          passportState,
          passportIssuingCountry,
          passportIssuingDate,
  ...
  savePassport: isUserAuthedProcedure
    .input(
      z.object({
        ...
        passportDocumentType: z.string().nullable(),
    ...
    .mutation(async (opts) => {
      ...
      await prisma.form.update({
        ...
        data: {
          ...
          visaIssuingDate,
          visaNumber,
          alreadyHaveVisa: USAVisaConfirmation === "Sim" ? alreadyHaveVisa === "Sim" : null,
  ...
  getAdditionalInformation: isUserAuthedProcedure
    ...
    .query(async (opts) => {
      ...
      const additionalInformationForm = await prisma.form.findFirst({
        ...
        select: {
          tribeParticipateConfirmation: true,
          languages: true,
  ...
  saveAdditionalInformation: isUserAuthedProcedure
    .input(
      z.object({
        profileId: z.string().min(1),
        redirectStep: z.number().optional(),
        tribeParticipateConfirmation: z.enum(["Sim", "Não"]).nullable(),
        languages: z.array(z.string().min(1, { message: "Idioma precisa ser preenchido" })),
        fiveYearsOtherCountryTravelsConfirmation: z.enum(["Sim", "Não"]),
        fiveYearsOtherCountryTravels: z.array(z.string().min(1, { message: "Países precisam ser preenchidos" })),
        socialOrganizationConfirmation: z.enum(["Sim", "Não"]),
